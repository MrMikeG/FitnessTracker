...
export default function Home() {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-6xl px-4 pb-44 pt-5 sm:px-7 sm:pt-8">
      ...
      <footer className="fixed inset-x-0 bottom-0 z-20 border-t border-white/10 bg-[#0c0e0c]/95 px-4 pb-[calc(2rem+env(safe-area-inset-bottom))] pt-3 backdrop-blur-xl">
